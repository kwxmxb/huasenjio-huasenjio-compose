 ...
 * @LastEditTime: 2022-12-20 21:57:23
 * @Description: 
-->
<template>
        ...
        <ul>
          <li>
            <div class="left">
              ...
              <div class="detail">推送存储本地数据至云端服务器</div>
            </div>
            <div class="right">
          ...
          <li>
            <div class="left">
              <div class="title">应用皮肤主题</div>
              <div class="detail">应用云端已存储的皮肤主题</div>
            </div>
            <div class="right">
          ...
          <li>
            <div class="left">
              ...
              <div class="detail">拉取云端收录的自定义网站</div>
            </div>
            <div class="right">
